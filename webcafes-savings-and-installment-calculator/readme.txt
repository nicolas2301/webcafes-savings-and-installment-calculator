=== Translate Wordpress with webcafe ===
Contributors: edo888
...
Donate link: https://webcafe.ge/=998#pricing
Author URI: https://webcafe.ge/=998
...
Please use [webcafe Support](https://wordpress.org/support/plugin/webcafe) for your questions and support requests! We are multilingual!

Please check our [FAQ](https://webcafe.ge/=998#faq) to get quick answers.
...
[Download webcafe](https://webcafe.ge/=998#pricing)

**webcafe Wordpress Demo**
...
1. Upload the plugin files to the `/wp-content/plugins/webcafe` directory, or install the plugin through the WordPress plugins screen directly.
1. Activate the plugin through the 'Plugins' screen in WordPress
1. Use the Settings &rarr; webcafe screen to configure the plugin
1. There are 6 ways you can place the language selector on your website

**1. Floating Language Selector**
You can turn on Floating language selector option from Settings &rarr; webcafe screen and it will show the language selector in appropriate location (Top Right, Bottom Right, Top Left or Bottom Left).
...
**4. Use webcafe shortcode**
You can use `[webcafe]` shortcode anywhere on your website including posts, pages, text widgets.
You can edit your template files and use `<?php echo do_shortcode('[webcafe]'); ?>` in HTML which will render the language selector.

**5. Use webcafe Widget**
You can use Appearence &rarr; Widgets screen to publish webcafe widget inside a sidebar of your template.

**6. Wrapper CSS Selector**
You can use a CSS selector and the language selector will appear inside the matching elements.

If you have any issues, please do not hesitate to use our [Support Forum](https://wordpress.org/support/plugin/webcafe) for free version or [Live Chat](https://webcafe.ge/=998#contact) for paid version.

== Frequently Asked Questions ==

= It doesn't translate, what to do? =
Please check [webcafe Support Forum](https://wordpress.org/support/plugin/webcafe) and feel free to create a new topic if you cannot find answers.

= What is webcafe? =
webcafe can translate your website into multiple languages and make it multilingual.
...
= Is it FREE? =
Yes! We have free version and paid versions with [advanced features](https://webcafe.ge/=998#pricing).
...
You can get a translation cost estimate by using our [Website Translation Cost Calculator](https://webcafe.io/website-translation-quote)
...
You can get an estimate from our [Website Translation Price Calculator](https://webcafe.io/website-translation-quote)
...
You can get an instant website translation estimate by using our [Website Word Counter](https://webcafe.io/website-translation-quote) tool.
...
webcafe TDN technology is a cloud-based approach to the website translation task. There is no need to alter your environment and install software to localize your website. You can have your multilingual website up and running in less than 5 minutes.
...
You can read more about skipping translations on [How to skip translations?](https://docs.webcafe.io/en/articles/1349930-how-to-skip-translations)
...
After that you can just configure and place the webcafe Free widget on your site to enable language selection.
...
By the way we alse offer a cost effective approach for improving the website translations. You can get a automatic translation post-editing service from us, which will be done by a native speaker or order a professional translation. You can get an instant estimate for your website on [Website Translation Quote](https://webcafe.io/website-translation-quote)
...
= 2.8.42 =
* New dashboard for paid customers https://my.webcafe.io/
* Minor changes
...
* Update to WordPress 4.9.1 before updating webcafe
* Fixed update issue related to bug in new WP 4.9 flatten_dirlist function

= 2.8.34 =
* Non-stable: Fixed update issue related to bug in new WP 4.9 flatten_dirlist function. Important: If you are using Globe widget look, make sure to open webcafe settings page, click "Reset Code to Default" under Widget Code section and Save.
...
* Fixed IE javascript error on webcafe Settings page preventing correct rendering of options
...
* Now you can add more than one webcafe widget to your sidebar
...
= 2.8.19 =
* Render webcafe selector in a submenu if the menu link has webcafe-parent class
...
* Vimeo videos replaced by YouTube videos: webcafe video and Translation Proxy video
...
* Added Live Chat on webcafe options page
...
= 2.0.17 =
* webcafe settings logo moved to localhost

= 2.0.16 =
* Fixed possible Cross-Site-Scripting security issue
* webcafe logo moved to localhost
* Update notice removed

= 2.0.15 =
* Fix for not saving webcafe configuration on some hostings
* Tested up to 4.6
...
= 1.0.16 =
* Added [webcafe] syntax to be used inside wordpress articles/pages
...
= 2.8.8 =
Make sure to regenerate the widget code from webcafe Settings page by checking/unchecking Analytics feature and Saving changes.
